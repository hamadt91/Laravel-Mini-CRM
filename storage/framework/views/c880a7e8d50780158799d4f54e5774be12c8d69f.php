                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <p class="text-sm">Enter your Company data.</p>
                                    <form action="<?php echo e(route('admin.company.store')); ?>" method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="mb-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Mini-CRM\resources\views/admin/company/create.blade.php ENDPATH**/ ?>