                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="h4 mb-0">Entry Form</h3>
                                </div>
                                <div class="card-body pt-0">
                                    <p class="text-sm">Enter your Company data.</p>
                                    <form action="<?php echo e(route('admin.company.store')); ?>" method="post"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Mini-CRM/resources/views/admin/company/create.blade.php ENDPATH**/ ?>