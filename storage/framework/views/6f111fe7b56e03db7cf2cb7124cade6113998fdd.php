                                    ...
                                    <form action="<?php echo e(route('admin.employee.update', $employee->id)); ?>" method="post"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="exampleInputEmail1" type="text"
                                                   aria-describedby="emailHelp" name="name" value="<?php echo e($employee->name); ?>">
                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Mini-CRM\resources\views/admin/employee/edit.blade.php ENDPATH**/ ?>