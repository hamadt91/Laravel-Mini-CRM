...
unset($__errorArgs, $__bag); ?> "
                                                   ...
                                                   name="first_name" value="<?php echo e($employee->first_name); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                   id="exampleInputEmail1" type="text"
                                                   name="last_name" value="<?php echo e($employee->last_name); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                   ...
                                                   name="email" value="<?php echo e($employee->email); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select mb-3 <?php $__errorArgs = ['company'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($company->id); ?>" <?php echo e($company->id == $employee->company_id ? "selected" : ''); ?> ><?php echo e($company->name); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                                   id="exampleInputEmail1" type="text"
                                                   name="phone" value="<?php echo e($employee->phone); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Mini-CRM/resources/views/admin/employee/edit.blade.php ENDPATH**/ ?>